        ...
        <div class="row">
            <div class="col-8">
                ...
                <div class="row text-center nav_h" style="height: 50px;line-height: 50px">
                    ...
                    <div class="col-2"><a href="admin.php?hotarticle">热门文章</a></div>
                    <div class="col-2"><a href="./admin.php?leavemessage">留言</a></div>
                    <div class="col-2"><a href="./admin.php?aboutus">关于我们</a></div>
                </div>
            </div>
            <div class="col-4">
                <div class="row">
                ...
                <div style="height: 43px;border: 1px solid #c5b164;margin-top: 10px">
                    <div class="input-group mb-3">
                        <form action="./admin.php"  method="get">
                            <a href="./admin.php?page=<?=$p.$urlext?>"></a>
        ...
        <p class="wow bounceInUp">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;我们会经常发布一些或大或小历史事件的博文，欢迎来到此博客尽情讨论。</p>
                ...
                <div class="articlebox" style=" overflow: hidden;">
                	...
                	//			exit;
                			echo '
                				<div class="article">
                				<h4><a href="admin.php?arid='.$v['arid'].'"> '.$v['title'].' </a></h4>
                				<hr>
                				<div class="content"> '.$v['content'].' </div>
                				</div>
                				';
